...
public class Test extends Thread {
	 ...
	 */
	public static void main(String[] args) throws ConnectionPoolException, SQLException, CompanyDaodbException, CustomerDaoDbException, CryptoHashException, CouponDaoDbException {
